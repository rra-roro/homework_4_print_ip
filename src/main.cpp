...
int main(int argc, char* argv[])
{
      try
      {
            ...
            output_ip(string("192.168.0.10"));
            output_ip(vector<char>{ -1, -1, -1, -1 });
            output_ip(list<unsigned short>{ 49320, 257 });
            output_ip(make_tuple<int8_t, int8_t, int8_t, int8_t>(1, 1, 1, 1));
      }
